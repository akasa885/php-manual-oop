...
<body>
    ...
    <nav class="fixed flex justify-between py-6 w-full lg:px-48 md:px-12 px-4 content-center bg-secondary z-10">
        <div class="flex items-center">
            <img src='<?= asset('assets/media/Logo_black.svg') ?>' alt="Logo" class="h-4" />
        </div>
    ...
    <section class="pt-24 md:mt-0 md:h-screen flex flex-col justify-center text-center md:text-left md:flex-row md:justify-between md:items-center lg:px-48 md:px-12 px-4 bg-secondary">
        ...
        <div class="flex justify-around md:block mt-8 md:mt-0 md:flex-1">
            <div class="relative">
                <img src='<?= asset('assets/media/Highlight1.svg') ?>' alt="" class="absolute -top-16 -left-10" />
            </div>
            <img src='<?= asset('assets/media/MacBook Pro.png') ?>' alt="Macbook" />
            <div class="relative">
                <img src='<?= asset('assets/media/Highlight2.svg') ?>' alt="" class="absolute -bottom-10 -right-6" />
            </div>
        </div>
    </section>
    ...
    <section class="sectionSize bg-secondary">
        ...
        <div class="md:grid md:grid-cols-2 md:grid-rows-2">
            ...
            <div class="flex items-start font-montserrat my-6 mr-10">
                <img src='<?= asset('assets/media/logos/Heart.svg') ?>' alt='' class="h-7 mr-4" />
                <div>
    ...
    <section class="sectionSize bg-secondary py-0">
        ...
        <div class="flex w-full flex-col md:flex-row">
            ...
            <div class='flex-1 flex flex-col mx-6 shadow-2xl relative bg-secondary rounded-2xl py-5 px-8 my-8 md:top-24'>
                ...
                <div class="flex">
                    <img src='<?= asset('assets/media/logos/CheckedBox.svg') ?>' alt="" class="mr-1" />
                    <p>Benefit #1</p>
                </div>
                <div class="flex">
                    <img src='<?= asset('assets/media/logos/CheckedBox.svg') ?>' alt="" class="mr-1" />
    ...
    <section class="sectionSize items-start pt-8 md:pt-36 bg-black text-white">
        ...
        <div toggleElement class="w-full py-4">
            <div class="flex justify-between items-center">
                ...
                <img src='<?= asset('assets/media/logos/CaretRight.svg') ?>' alt="" class="transform transition-transform" />
            </div>
    ...
    <section class="bg-black sectionSize">
        <div class="mb-4">
            <img src='<?= asset('assets/media/Logo_white.svg') ?>' alt="Logo" class="h-4" />
        </div>
        <div class="flex mb-8">
            <a href="#">
                <img src='<?= asset('assets/media/logos/Facebook.svg') ?>' alt="Facebook logo" class="mx-4" />
            </a>
            <a href="#">
                <img src='<?= asset('assets/media/logos/Youtube.svg') ?>' alt="Youtube logo" class="mx-4" />
            </a>
            <a href="#">
                <img src='<?= asset('assets/media/logos/Instagram.svg') ?>' alt="Instagram logo" class="mx-4" />
            </a>
            <a href="#">
                <img src='<?= asset('assets/media/logos/Twitter.svg') ?>' alt="Twitter logo" class="mx-4" />
            </a>
        </div>
